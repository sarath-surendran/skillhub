...
//   }
  ...
  const options = {
    ...
    colors: ['#FFA70B', '#259AE6'],
    labels: ['Paid Enrollments', 'Free Enrollments'],
    legend: {
      show: true,
      position: 'bottom',
    },
...
const DashboardEnrollmentsChart = () => {
    ...
    //   const paidPercentage = (paidEnrollments.length/enrollmentCount)*100
    //   const freePercentage = (freeEnrollments.length/enrollmentCount)*100
      ...
      }, [paidEnrollments, freeEnrollments]);
  ...
  return (
    <div className='pt-4'>
      ...
      <div className="mb-3 justify-between gap-4 sm:flex">
        <div>
          <h5 className="text-xl font-semibold text-black dark:text-white p-4">
...
export default DashboardEnrollmentsChart
